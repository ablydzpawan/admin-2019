							...
							<div class="row  no-gutters row-col-separator-lg">
								...
								<div class="col-md-12 col-lg-6 col-xl-3">
									...
									<div class="widget24">
										...
										<div class="progress progress--sm">
											<div class="progress-bar bg-brand" role="progressbar" style="width: 78%;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
										</div>
								...
								<div class="col-md-12 col-lg-6 col-xl-3">
									...
									<div class="widget24">
										...
										<div class="progress progress--sm">
											<div class="progress-bar bg-warning" role="progressbar" style="width: 84%;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
										</div>
        ...
        <div class="widget33">
            ...
            <div class="widget33__foot">
              ...
              <div class="widget33__button">
                  <button type="button" class="btn btn-brand btn-md  btn-bold">Check Out</button>
              </div>
            </div>
        </div>
        <!--end::Widget -->
...
<!--End::Portlet-->
						...
						<div class="col-xl-4">
							<!--begin:: Widgets/Blog-->
							<div class="portlet portlet--height-fluid widget19">
								<div class="portlet__body portlet__body--fit portlet__body--unfill">
									<div class="widget19__pic portlet-fit--top portlet-fit--sides" style="min-height: 300px; background-image: url(media/product4.jpg)">
						...
						<div class="col-xl-4">
							...
							<div class="portlet bg-danger portlet--skin-solid portlet--height-fluid">
					...
					<div class="row">
								...
								<div class="portlet__body">
									<div class="widget12">
										<div class="widget12__content">
											...
											<div class="widget12__item">
												<div class="widget12__info">
													<span class="widget12__desc">Total Annual Profit Before Tax</span>
											...
											<div class="widget12__item">
												...
												<div class="widget12__info">
													...
													<span class="widget12__progress">
														<div class="progress progress-sm">
															<div class="progress-bar bg-brand" role="progressbar" style="width: 63%" aria-valuenow="63" aria-valuemin="0" aria-valuemax="100"></div>
														</div>
						...
						<div class="col-xl-4">
							...
							<div class="portlet bg-brand portlet--skin-solid portlet--height-fluid">
								<div class="portlet__head portlet__head--noborder">
									<div class="portlet__head-label">
										<h3 class="portlet__head-title">
											Announcements
					...
					<div class="row">
						<div class="col-xl-4">
							...
							<div class="portlet portlet--fit portlet--head-lg portlet--head-overlay portlet--height-fluid">
								<div class="portlet__head portlet__space-x">
									<div class="portlet__head-label">
										<h3 class="portlet__head-title font-light">
											Personal Income
										</h3>
									</div>
									<div class="portlet__head-toolbar">
								...
								<div class="portlet__body">
									<div class="widget27">
										...
										<div class="widget27__container portlet__space-x">
														...
														<div class="table-responsive">
															...
															<table class="table">
																...
																<tbody>
																	<tr>
																		<td>
																			<a href="#" class="widget11__title">Vertex 2.0</a>
																			<span class="widget11__sub">Vertex To By Again</span>
																		</td>
																		<td><span class="badge badge--success badge--inline">pending</span></td>
																		<td class="align-right font-brand font-bold">$14,740</td>
																	</tr>
																	<tr>
																		<td>
																			<a href="#" class="widget11__title">Metronic</a>
																			<span class="widget11__sub">Powerful Admin Theme</span>
																		</td>
																		<td><span class="badge badge--brand badge--inline">new</span></td>
														...
														<div class="table-responsive">
															...
															<table class="table">
																...
																<tbody>
																	...
																	<tr>
																		<td>
																			<a href="#" class="widget11__title">Apex</a>
																			<span class="widget11__sub">The Best Selling App</span>
																		</td>
																		<td><span class="badge badge--warning badge--inline">in process</span></td>
						...
						<div class="col-xl-4">
							...
							<div class="portlet portlet--fit portlet--head-lg portlet--head-overlay portlet--height-fluid">
								...
								<div class="portlet__body">
									<div class="widget28">
										<div class="widget28__visual" style="background-image: url(media/bg/bg-page-section.png)"></div>
										<div class="widget28__wrapper portlet__space-x">
											<!-- begin::Nav pills -->
											<ul class="nav nav-pills nav-fill portlet__space-x" role="tablist">
												<li class="nav-item">
						...
						<div class="col-xl-4">
							<!--begin:: Packages-->
							<div class="portlet portlet--skin-solid portlet--solid-warning portlet--head-lg portlet--head-overlay portlet--height-fluid">
								<div class="portlet__head portlet__head--noborder">
									<div class="portlet__head-label">
										<h3 class="portlet__head-title font-light">
											Packages
								...
								<div class="portlet__body margin-t-0 padding-t-0">
									<!--begin::Widget 29-->
									<div class="widget29">
					...
					<div class="row">
						<div class="col-xl-4">
							...
							<div class="portlet portlet--height-fluid">
								...
								<div class="portlet__body portlet__body--fit-y">
									<!--begin::Widget -->
									<div class="widget widget--user-profile-1">
										...
										<div class="widget__body">
											...
											<div class="widget__items">
												<a href="user/profile-1/overview.html" class="widget__item widget__item--active">
												...
												<a href="user/profile-1/personal-information.html" class="widget__item ">
													<span class="widget__section">
														<span class="widget__icon">
															<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-icon">
																<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
												...
												<a href="user/profile-1/account-information.html" class="widget__item ">
													<span class="widget__section">
														<span class="widget__icon">
															<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-icon">
																<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
					...
					<div class="row">
						<div class="col-xl-6">
							...
							<div class="portlet portlet--bordered-semi portlet--space portlet--height-fluid">
								<div class="portlet__head">
									<div class="portlet__head-label">
										<h3 class="portlet__head-title">
											Product Sales
									...
									<div class="widget25">
										...
										<div class="widget25__items">
											<div class="widget25__item">
												...
												<div class="progress progress--sm">
													<div class="progress-bar bg-danger" role="progressbar" style="width: 63%;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
												</div>
											...
											<div class="widget25__item">
												...
												<div class="progress m-progress--sm">
													<div class="progress-bar bg-warning" role="progressbar" style="width: 54%;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
												</div>
												<span class="widget25__desc">
													Product Growth
												</span>
											...
											<div class="widget__stats">
												...
												<div class="widget__item flex-fill">
													...
													<div class="widget__progress d-flex  align-items-center">
														<div class="progress" style="height: 5px;width: 100%;">
															<div class="progress-bar bg-warning" role="progressbar" style="width: 78%;" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
														</div>
											...
											<div class="widget__wrapper">
												<div class="widget__section">
													...
													<div class="widget__blog">
														...
														<a href="#" class="widget__value font-brand">648 Comments</a>
													</div>
												</div>
