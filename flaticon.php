				...
				<div id="subheader" class="subheader" >
					<div class="container ">
						<div class="subheader__main">
							<h3 class="subheader__title">Flaticon</h3>
						...
						<div class="col">
							<div class="alert alert-light alert-elevate fade show" role="alert">
								...
								<div class="alert-text">
									...
									<br>
									For more info please visit the plugin's <a class="link font-bold" href="https://www.flaticon.com/" target="_blank">Demo Page</a>.
								</div>
							</div>
						</div>
					</div>
							...
							<div class="portlet">
								<div class="portlet__head">
									<div class="portlet__head-label">
										<span class="portlet__head-icon hidden">
								...
								<div class="portlet__body">
									<div class="row">
										<div class="col-md-2">
											<div class="demo-icon">
												<div class="demo-icon__preview">
													<i class="flaticon-email-black-circular-button"></i>
												</div>
												<div class="demo-icon__class">
									...
									<div class="row">
										...
										<div class="col-md-2">
											<div class="demo-icon">
												...
												<div class="demo-icon__class">
													flaticon2-heart-rate-monitor </div>
											</div>
										</div>
										<div class="col-md-2">
											<div class="demo-icon">
										...
										<div class="col-md-2">
											<div class="demo-icon">
												...
												<div class="demo-icon__class">
													flaticon2-delivery-package </div>
											</div>
										</div>
										<div class="col-md-2">
											<div class="demo-icon">
									...
									<div class="row">
										...
										<div class="col-md-2">
											<div class="demo-icon">
												...
												<div class="demo-icon__class">
													flaticon2-digital-marketing </div>
											</div>
										</div>
										<div class="col-md-2">
											<div class="demo-icon">
									...
									<div class="row">
										...
										<div class="col-md-2">
											<div class="demo-icon">
												...
												<div class="demo-icon__class">
													flaticon2-pie-chart-2 </div>
											</div>
										</div>
										<div class="col-md-2">
											<div class="demo-icon">
												<div class="demo-icon__preview">
													<i class="flaticon2-analytics-1"></i>
												</div>
												<div class="demo-icon__class">
													flaticon2-analytics-1 </div>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-2">
											<div class="demo-icon">
												<div class="demo-icon__preview">
													<i class="flaticon2-google-drive-file"></i>
												</div>
												<div class="demo-icon__class">
													flaticon2-google-drive-file </div>
											</div>
										</div>
										<div class="col-md-2">
											<div class="demo-icon">
												<div class="demo-icon__preview">
													<i class="flaticon2-pie-chart-3"></i>
												</div>
												<div class="demo-icon__class">
													flaticon2-pie-chart-3 </div>
											</div>
										</div>
										<div class="col-md-2">
											<div class="demo-icon">
									...
									<div class="row">
										...
										<div class="col-md-2">
											<div class="demo-icon">
												...
												<div class="demo-icon__class">
													flaticon2-rectangular </div>
											</div>
										</div>
										<div class="col-md-2">
											<div class="demo-icon">
												<div class="demo-icon__preview">
													<i class="flaticon2-medical-records-1"></i>
												</div>
												<div class="demo-icon__class">
													flaticon2-medical-records-1 </div>
											</div>
										</div>
										<div class="col-md-2">
											<div class="demo-icon">
									...
									<div class="row">
										...
										<div class="col-md-2">
											<div class="demo-icon">
												...
												<div class="demo-icon__class">
													flaticon2-add-circular-button </div>
											</div>
										</div>
										<div class="col-md-2">
											<div class="demo-icon">
									...
									<div class="row">
										...
										<div class="col-md-2">
											<div class="demo-icon">
												...
												<div class="demo-icon__class">
													flaticon2-zig-zag-line-sign </div>
											</div>
										</div>
										<div class="col-md-2">
											<div class="demo-icon">
												...
												<div class="demo-icon__class">
													flaticon2-tools-and-utensils </div>
											</div>
										</div>
										<div class="col-md-2">
											<div class="demo-icon">
									...
									<div class="row">
										...
										<div class="col-md-2">
											<div class="demo-icon">
												...
												<div class="demo-icon__class">
													flaticon2-bell-alarm-symbol </div>
											</div>
										</div>
										<div class="col-md-2">
											<div class="demo-icon">
									...
									<div class="row">
										<div class="col-md-2">
											<div class="demo-icon">
												...
												<div class="demo-icon__class">
													flaticon2-architecture-and-city </div>
											</div>
										</div>
										<div class="col-md-2">
											<div class="demo-icon">
										...
										<div class="col-md-2">
											<div class="demo-icon">
												...
												<div class="demo-icon__class">
													flaticon2-user-outline-symbol </div>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-2">
											<div class="demo-icon">
												<div class="demo-icon__preview">
													<i class="flaticon2-rhombus"></i>
												</div>
												<div class="demo-icon__class">
													flaticon2-rhombus </div>
											</div>
										</div>
										<div class="col-md-2">
											<div class="demo-icon">
										...
										<div class="col-md-2">
											<div class="demo-icon">
												<div class="demo-icon__preview">
													<i class="flaticon2-contrast"></i>
												</div>
												<div class="demo-icon__class">
													flaticon2-contrast </div>
											</div>
										</div>
									</div>
									<div class="row">
										...
										<div class="col-md-2">
											<div class="demo-icon">
												...
												<div class="demo-icon__class">
													flaticon2-telegram-logo </div>
											</div>
										</div>
										<div class="col-md-2">
											<div class="demo-icon">
												<div class="demo-icon__preview">
													<i class="flaticon2-hangouts-logo"></i>
												</div>
												<div class="demo-icon__class">
													flaticon2-hangouts-logo </div>
											</div>
										</div>
										<div class="col-md-2">
											<div class="demo-icon">
									...
									<div class="row">
										...
										<div class="col-md-2">
											<div class="demo-icon">
												...
												<div class="demo-icon__class">
													flaticon2-add-square </div>
											</div>
										</div>
										<div class="col-md-2">
											<div class="demo-icon">
												<div class="demo-icon__preview">
													<i class="flaticon2-quotation-mark"></i>
												</div>
												<div class="demo-icon__class">
													flaticon2-quotation-mark </div>
											</div>
										</div>
									</div>
									<div class="row">
									...
									<div class="row">
										...
										<div class="col-md-2">
											<div class="demo-icon">
												...
												<div class="demo-icon__class">
													flaticon2-files-and-folders </div>
											</div>
										</div>
										<div class="col-md-2">
											<div class="demo-icon">
												<div class="demo-icon__preview">
													<i class="flaticon2-ui"></i>
												</div>
												<div class="demo-icon__class">
													flaticon2-ui </div>
											</div>
