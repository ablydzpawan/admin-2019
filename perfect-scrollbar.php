		...
		<div class="body grid__item grid__item--fluid grid grid--hor grid--stretch" id="body">
			<div class="content content--fit-top  grid__item grid__item--fluid grid grid--hor" id="content">
				...
				<div class="container  grid__item grid__item--fluid">
						...
						<div class="col">
							<div class="alert alert-light alert-elevate fade show" role="alert">
								...
								<div class="alert-text">
									...
									<br>
									For more info please visit the plugin's <a class="link font-bold" href="http://utatti.github.io/perfect-scrollbar/" target="_blank">Demo Page</a> or <a class="link font-bold" href="https://github.com/utatti/perfect-scrollbar/" target="_blank">Github Repo</a>.
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-lg-6">
							...
							<div class="portlet">
								...
								<div class="portlet__body">
									<div class="scroll scroll-y" data-scroll="true" style="height: 200px;" data-simplebar >
						...
						<div class="col-lg-6">
							...
							<div class="portlet">
								...
								<div class="portlet__body">
									<div class="scroll scroll-y" data-scroll="true" data-scroll-x="true" style="height: 200px;" data-simplebar>
					...
					<!--begin::Modal-->
					<div class="modal fade" id="scrollable_modal_1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="display: none;">
