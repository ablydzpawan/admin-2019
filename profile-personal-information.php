			...
			<div class="content content--fit-top  grid__item grid__item--fluid grid grid--hor" id="content">
				...
				<div class="container  grid__item grid__item--fluid">
					...
					<div class="grid grid--desktop grid--ver grid--ver-desktop app">
						...
						<!--Begin:: App Aside-->
						<div class="grid__item app__toggle app__aside" id="user_profile_aside">
									...
									<div class="widget widget--user-profile-1">
										...
										<div class="widget__body">
											...
											<div class="widget__items">
												...
												<a href="user/profile-1/personal-information.html" class="widget__item widget__item--active">
													<span class="widget__section">
														<span class="widget__icon">
															<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-icon">
																<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
