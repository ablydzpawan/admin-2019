						...
						<form class="form form--label-right">
							<div class="portlet__body">
								...
								<div class="form-group row">
									...
									<div class="col-lg-4 col-md-9 col-sm-12">
										<div class="dropdown bootstrap-select form-control "><select class="form-control selectpicker" data-size="4" tabindex="-98">
												<option>Mustard</option>
												<option>Ketchup</option>
												<option>Relish</option>
												<option>Tent</option>
								...
								<div class="form-group row">
									...
									<div class="col-lg-4 col-md-9 col-sm-12">
										<div class="dropdown bootstrap-select form-control  dropup"><select class="form-control selectpicker" tabindex="-98">
											...
											</select><button type="button" class="btn dropdown-toggle btn-light" data-toggle="dropdown" role="button" title="Mustard" aria-expanded="false">
												<div class="filter-option">
													<div class="filter-option-inner">
														<div class="filter-option-inner-inner">Mustard</div>
													</div>
											...
											<div class="dropdown-menu" role="combobox" style="max-height: 499.6px; overflow: hidden; min-height: 147px; position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, -3px, 0px);" x-placement="top-start">
												<div class="inner show" role="listbox" aria-expanded="false" tabindex="-1" style="max-height: 473.6px; overflow-y: auto; min-height: 121px;">
													<ul class="dropdown-menu inner show">
														<li class="dropdown-header optgroup-1"><span class="text">Picnic</span></li>
														<li class="optgroup-1 selected active"><a role="option" class="opt dropdown-item selected active" aria-disabled="false" tabindex="0" aria-selected="true"><span class="text">Mustard</span></a></li>
														<li class="optgroup-1"><a role="option" class="opt dropdown-item" aria-disabled="false" tabindex="0" aria-selected="false"><span class="text">Ketchup</span></a></li>
														<li class="optgroup-1"><a role="option" class="opt dropdown-item" aria-disabled="false" tabindex="0" aria-selected="false"><span class="text">Relish</span></a></li>
														<li class="dropdown-divider optgroup-2div"></li>
														<li class="dropdown-header optgroup-2"><span class="text">Camping</span></li>
														<li class="optgroup-2"><a role="option" class="opt dropdown-item" aria-disabled="false" tabindex="0" aria-selected="false"><span class="text">Tent</span></a></li>
														<li class="optgroup-2"><a role="option" class="opt dropdown-item" aria-disabled="false" tabindex="0" aria-selected="false"><span class="text">Flashlight</span></a></li>
														<li class="optgroup-2"><a role="option" class="opt dropdown-item" aria-disabled="false" tabindex="0" aria-selected="false"><span class="text">Toilet Paper</span></a></li>
													</ul>
												</div>
											</div>
										</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-4 col-md-9 col-sm-12">
										<div class="dropdown bootstrap-select show-tick form-control "><select class="form-control selectpicker" multiple="" tabindex="-98">
												<option>Mustard</option>
												<option>Ketchup</option>
												<option>Relish</option>
								...
								<div class="form-group row">
									...
									<div class="col-lg-4 col-md-9 col-sm-12">
										<div class="dropdown bootstrap-select show-tick form-control form-control--fixed " style="width: 200px;"><select class="form-control form-control--fixed selectpicker" multiple="" data-max-options="2" data-width="200" tabindex="-98">
												<option>Mustard</option>
												<option>Ketchup</option>
												<option>Relish</option>
											</select><button type="button" class="btn dropdown-toggle bs-placeholder btn-light" data-toggle="dropdown" role="button" title="Nothing selected">
										...
										<div class="dropdown bootstrap-select show-tick form-control form-control--fixed " style="width: 200px;"><select class="form-control form-control--fixed selectpicker" multiple="" data-width="200" tabindex="-98">
								...
								<div class="form-group row">
									...
									<div class="col-lg-4 col-md-9 col-sm-12">
										<div class="dropdown bootstrap-select form-control "><select class="form-control selectpicker" title="Choose one of the following..." tabindex="-98">
												<option class="bs-title-option" value=""></option>
												<option>Mustard</option>
												<option>Ketchup</option>
												<option>Relish</option>
											</select><button type="button" class="btn dropdown-toggle bs-placeholder btn-light" data-toggle="dropdown" role="button" title="Choose one of the following...">
												<div class="filter-option">
													<div class="filter-option-inner">
														<div class="filter-option-inner-inner">Choose one of the following...</div>
													</div>
												</div>
											</button>
											<div class="dropdown-menu " role="combobox">
								...
								<div class="form-group row">
									...
									<div class="col-lg-4 col-md-9 col-sm-12">
										<div class="dropdown bootstrap-select form-control "><select class="form-control selectpicker" title="Choose one of the following..." tabindex="-98">
											...
											</select><button type="button" class="btn dropdown-toggle btn-light" data-toggle="dropdown" role="button" title="Combo 2">
												<div class="filter-option">
													<div class="filter-option-inner">
														<div class="filter-option-inner-inner">Combo 2</div>
													</div>
												</div>
											</button>
											<div class="dropdown-menu " role="combobox">
								...
								<div class="form-group row">
									...
									<div class="col-lg-4 col-md-9 col-sm-12">
										<div class="dropdown bootstrap-select show-tick form-control "><select class="form-control selectpicker" multiple="" data-selected-text-format="count" tabindex="-98">
												<option title="Combo 1">Hot Dog, Fries and a Soda</option>
												<option title="Combo 2">Burger, Shake and a Smile</option>
												<option title="Combo 3" selected="">Sugar, Spice and all things nice</option>
											</select><button type="button" class="btn dropdown-toggle btn-light" data-toggle="dropdown" role="button" title="Combo 3">
												<div class="filter-option">
													<div class="filter-option-inner">
														<div class="filter-option-inner-inner">Combo 3</div>
													</div>
												</div>
											</button>
											<div class="dropdown-menu " role="combobox">
										...
										<div class="dropdown bootstrap-select show-tick form-control "><select class="form-control selectpicker" multiple="" data-selected-text-format="count > 3" tabindex="-98">
												<option title="Combo 1" selected="">Hot Dog, Fries and a Soda</option>
												<option title="Combo 2">Burger, Shake and a Smile</option>
												<option title="Combo 3">Sugar, Spice and all things nice</option>
											</select><button type="button" class="btn dropdown-toggle btn-light" data-toggle="dropdown" role="button" title="Combo 1">
												<div class="filter-option">
													<div class="filter-option-inner">
														<div class="filter-option-inner-inner">Combo 1</div>
													</div>
												</div>
											</button>
											<div class="dropdown-menu " role="combobox">
