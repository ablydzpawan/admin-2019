					...
					<div class="content grid__item grid__item--fluid">
							...
							<div class="col-xl-6">
								...
								<div class="row row-full-height">
									<div class="col-sm-12 col-md-12 col-lg-6">
										<div class="portlet portlet--height-fluid-half portlet--border-bottom-brand">
										...
										<div class="portlet portlet--height-fluid-half portlet--border-bottom-danger">
											<div class="portlet__body portlet__body--fluid">
												<div class="widget26">
													<div class="widget26__content">
									...
									<div class="col-sm-12 col-md-12 col-lg-6">
										<div class="portlet portlet--height-fluid-half portlet--border-bottom-success">
											<div class="portlet__body portlet__body--fluid">
												<div class="widget26">
													<div class="widget26__content">
										...
										<div class="space-20"></div>
										<div class="portlet portlet--height-fluid-half portlet--border-bottom-warning">
											<div class="portlet__body portlet__body--fluid">
												<div class="widget26">
													<div class="widget26__content">
						...
						<div class="row">
							<div class="col-xl-4">
								...
								<div class="portlet portlet--head--noborder portlet--height-fluid">
							...
							<div class="col-xl-4">
								...
								<div class="portlet portlet--head--noborder portlet--height-fluid">
									...
									<div class="portlet__body portlet__body--fluid portlet__body--fit">
										<div class="widget4 widget4--sticky">
											<div class="widget4__chart">
												<div class="ct-chart-order-trends"></div>

											</div>
											<div class="widget4__items widget4__items--bottom portlet__space-x mb-4">
						...
						<div class="row">
							<div class="col-xl-12">
								<div class="portlet portlet--height-fluid portlet--mobile ">
									<div class="portlet__head portlet__head--lg portlet__head--noborder portlet__head--break-sm">
										<div class="portlet__head-label">
											<h3 class="portlet__head-title">
											...
											<table class="table datatable__table js--table-scrollable">
												<thead class="datatable__head">
													<tr class="datatable__row">
														...
														<th class="datatable__cell datatable__cell--sort datatable__cell--sorted"><span>Company <i class="flaticon2-arrow-up"></i></span></th>
						...
						<div class="row">
							...
							<div class="col-xl-6">
								...
								<div class="portlet portlet--height-fluid ">
									...
									<div class="portlet__body portlet__body--fluid portlet__body--fit">
										<div class="widget4 widget4--sticky">
											<div class="widget4__items portlet__space-x margin-t-15">
												<div class="widget4__item">
