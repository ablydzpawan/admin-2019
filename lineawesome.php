				...
				<div id="subheader" class="subheader" >
					<div class="container ">
						<div class="subheader__main">
							<h3 class="subheader__title">Lineawesome Icons</h3>
						...
						<div class="col">
							<div class="alert alert-light alert-elevate fade show" role="alert">
								...
								<div class="alert-text">
									...
									<br>
									For more info please visit the plugin's <a class="link font-bold" href="https://icons8.com/line-awesome" target="_blank">Demo Page</a>.
								</div>
							</div>
						</div>
					</div>
