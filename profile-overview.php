							...
							<div class="row">
								<div class="col-xl-6">
									...
									<div class="portlet portlet--height-fluid">
										...
										<div class="portlet__body portlet__body--fluid">
											<div class="widget12">
														...
														<div class="widget12__info">
															...
															<div class="widget12__progress">
																<div class="progress progress--sm">
																	<div class="progress-bar bg-brand" role="progressbar" style="width: 40%;" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
																</div>
												...
												<div class="widget12__chart" style="height:250px;">
													...
													<canvas id="chart_order_statistics" style="display: block; width: 415px; height: 250px;" width="415" height="250" class="chartjs-render-monitor"></canvas>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="col-xl-6">
									<!--begin:: Widgets/Tasks -->
									<div class="portlet portlet--tabs portlet--height-fluid">
										<div class="portlet__head">
											<div class="portlet__head-label">
												<h3 class="portlet__head-title">
													Tasks
										...
										<div class="portlet__body">
											<div class="tab-content">
												<div class="tab-pane active" id="widget2_tab1_content">
													<div class="widget2">
														<div class="widget2__item widget2__item--primary">
															...
															<div class="widget2__info">
																<a href="#" class="widget2__title">
																	Make Metronic Great Again.Lorem Ipsum Amet
																</a>
																<a href="#" class="widget2__username">
																	By Bob
																</a>
															</div>
												...
												<div class="tab-pane" id="widget2_tab3_content">
													<div class="widget2">
											...
											<div class="tab-content">
													...
													<div class="notification">
														<a href="#" class="notification__item">
															<div class="notification__item-icon">
																<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-icon svg-icon--brand">
																	<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																		<rect x="0" y="0" width="24" height="24"></rect>
												...
												<div class="tab-pane" id="widget6_tab2_content" aria-expanded="false">
													<div class="notification">
														...
														<a href="#" class="notification__item">
															<div class="notification__item-icon">
																<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-icon svg-icon--info">
																	<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																		<polygon points="0 0 24 0 24 24 0 24"></polygon>
												...
												<div class="tab-pane" id="widget6_tab3_content" aria-expanded="false">
													<div class="notification">
														<a href="#" class="notification__item">
															<div class="notification__item-icon">
																<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-icon svg-icon--warning">
																	<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																		<rect x="0" y="0" width="24" height="24"></rect>
																		<path d="M4,4 L11.6314229,2.5691082 C11.8750185,2.52343403 12.1249815,2.52343403 12.3685771,2.5691082 L20,4 L20,13.2830094 C20,16.2173861 18.4883464,18.9447835 16,20.5 L12.5299989,22.6687507 C12.2057287,22.8714196 11.7942713,22.8714196 11.4700011,22.6687507 L8,20.5 C5.51165358,18.9447835 4,16.2173861 4,13.2830094 L4,4 Z" fill="#000000" opacity="0.3"></path>
