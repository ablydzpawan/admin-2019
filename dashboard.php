								...
								<div class="portlet portlet--tabs portlet--height-fluid">
									<div class="portlet__head">
										<div class="portlet__head-label">
											<h3 class="portlet__head-title">Online store visits by location</h3>
										</div>
						...
						<div class="row">
							<div class="col-xl-4">
								<div class="portlet portlet--height-fluid">
									<div class="portlet__head">
										<div class="portlet__head-label">
											<h3 class="portlet__head-title">Top Products by units sold</h3>
										</div>
										<div class="portlet__head-toolbar">
							...
							<div class="col-xl-4">
								<div class="portlet portlet--height-fluid">
									<div class="portlet__head">
										<div class="portlet__head-label">
											<h3 class="portlet__head-title">Online store visits by traffic source</h3>
										</div>
										<div class="portlet__head-toolbar">
							...
							<div class="col-xl-4">
								<div class="portlet portlet--height-fluid">
									<div class="portlet__head">
										<div class="portlet__head-label">
											<h3 class="portlet__head-title">Sales by traffic source</h3>
										</div>
										<div class="portlet__head-toolbar">
						...
						<div class="row">
							<div class="col-xl-4">
								<div class="portlet portlet--height-fluid">
									<div class="portlet__head">
										<div class="portlet__head-label">
											<h3 class="portlet__head-title">Top landing pages by visits</h3>
										</div>
										<div class="portlet__head-toolbar">
							...
							<div class="col-xl-4">
								<div class="portlet portlet--height-fluid">
									<div class="portlet__head">
										<div class="portlet__head-label">
											<h3 class="portlet__head-title">Online store visits by device type</h3>
										</div>
										<div class="portlet__head-toolbar">
											<button type="button" class="btn btn-label-brand btn-bold btn-sm">View Report</button>
										</div>
							...
							<div class="col-xl-4">
								<div class="portlet portlet--height-fluid">
									<div class="portlet__head">
										<div class="portlet__head-label">
											<h3 class="portlet__head-title">Online store visits from social sources</h3>
										</div>
										<div class="portlet__head-toolbar">
											<button type="button" class="btn btn-label-brand btn-bold btn-sm">View Report</button>
										</div>
