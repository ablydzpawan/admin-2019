									...
									<div class="widget widget--user-profile-1">
										...
										<div class="widget__body">
											...
											<div class="widget__items">
												<a href="user/profile-1/overview.html" class="widget__item ">
												...
												<a href="user/profile-1/account-information.html" class="widget__item widget__item--active">
													<span class="widget__section">
														<span class="widget__icon">
															<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-icon">
																<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
								...
								<div class="col-xl-12">
									<div class="portlet">
										<div class="portlet__head">
											<div class="portlet__head-label">
												<h3 class="portlet__head-title">Account Information <small>change your account settings</small></h3>
											</div>
											<div class="portlet__head-toolbar">
														...
														<div class="dropdown-menu dropdown-menu-right">
															<ul class="nav">
																<li class="nav__section nav__section--first">
																	<span class="nav__section-text">Export Tools</span>
																</li>
																<li class="nav__item">
																	<a href="#" class="nav__link">
										...
										<form class="form form--label-right">
											<div class="portlet__body">
													...
													<div class="section__body">
														<div class="row">
															...
															<div class="col-lg-9 col-xl-6">
																<h3 class="section__title section__title-sm">Account:</h3>
															</div>
														</div>
														...
														<div class="form-group row">
															...
															<div class="col-lg-9 col-xl-6">
																...
																<span class="form-text text-muted">Email will not be publicly displayed. <a href="#" class="link">Learn more</a>.</span>
															</div>
														</div>
														<div class="form-group row">
												...
												<div class="separator separator--border-dashed separator--portlet-fit separator--space-lg"></div>
												...
												<div class="section section--first">
													<div class="section__body">
														<div class="row">
															<label class="col-xl-3"></label>
															<div class="col-lg-9 col-xl-6">
																<h3 class="section__title section__title-sm">Security:</h3>
															</div>
														</div>
														<div class="form-group row">
															<label class="col-xl-3 col-lg-3 col-form-label">Login verification</label>
															<div class="col-lg-9 col-xl-6">
																<button type="button" class="btn btn-label-brand btn-bold btn-sm margin-t-5 margin-b-5">Setup login verification</button>
														...
														<div class="form-group row margin-t-10 margin-b-10">
															<label class="col-xl-3 col-lg-3 col-form-label"></label>
															<div class="col-lg-9 col-xl-6">
																<button type="button" class="btn btn-label-danger btn-bold btn-sm margin-t-5 margin-b-5">Deactivate your account ?</button>
															</div>
														</div>
													</div>
												</div>
