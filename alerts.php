						...
						<div class="col">
							<div class="alert alert-light alert-elevate fade show" role="alert">
								...
								<div class="alert-text">
									FB-admin extends <code>Bootstrap Alert</code> component with a variety of options to provide uniquely looking Alert component that matches the FB-admin's design standards.
									<br>
						...
						<div class="col-xl-6">
							...
							<div class="portlet">
								...
								<div class="portlet__body">
									<!--begin::Section-->
									<div class="section">
										<div class="section__info">Alerts are available for any length of text, as well as an optional dismiss button.</div>
							...
							<div class="portlet">
								...
								<div class="portlet__body">
									<!--begin::Section-->
									<div class="section">
										<div class="section__info">Alerts can also contain additional HTML elements like headings, paragraphs and dividers.</div>
										<div class="section__content">
											<div class="demo">
