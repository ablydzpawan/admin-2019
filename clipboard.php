						...
						<div class="col">
							<div class="alert alert-light alert-elevate fade show" role="alert">
								...
								<div class="alert-text">
									...
									<br>
									For more info please visit the plugin's <a class="link font-bold" href="https://clipboardjs.com/" target="_blank">Demo Page</a> or <a class="link font-bold" href="https://github.com/zenorocha/clipboard.js" target="_blank">Github Repo</a>.
								</div>
							</div>
						</div>
					</div>
						...
						<form class="form form--label-right">
							<div class="portlet__body">
								<div class="form-group row">
									...
									<div class="col-lg-6 col-md-9 col-sm-12">
										<div class="input-group">
											<input type="text" class="form-control" id="clipboard_1" placeholder="Type some value to copy">
											<div class="input-group-append">
												<a href="#" class="btn btn-secondary" data-clipboard="true" data-clipboard-target="#clipboard_1"><i class="la la-copy"></i></a>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-6 col-md-9 col-sm-12">
										<div id="clipboard_4" style="border: 4px solid #eaeaea; padding: 10px;">Mussum ipsum cacilds, vidis litro abertis. Consetis adipiscings elitis. Pra lá , depois divoltis porris, paradis. Paisis, filhis, espiritis santis. Mé faiz elementum girarzis, nisi eros vermeio, in elementis mé pra quem é amistosis quis leo. Manduma pindureta quium dia nois paga.</div>
										<div class="space-10"></div>
