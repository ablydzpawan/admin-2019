						...
						<div class="col">
							<div class="alert alert-light alert-elevate fade show" role="alert">
								...
								<div class="alert-text">
									...
									<br>
									For more info please visit the plugin's <a class="link font-bold" href="https://getbootstrap.com/docs/4.3/components/button-group/" target="_blank">Documentation</a>.
								</div>
							</div>
						</div>
					</div>
						...
						<div class="col-md-6">
							...
							<div class="portlet">
								...
								<div class="portlet__body">
									<!--begin::Section-->
									<div class="section">
										<span class="section__info">Combine sets of <code>btn-group</code> into a <code>btn-toolbar</code> for more complex components:</span>
										<div class="section__content">
